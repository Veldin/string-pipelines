...
class RotateRightTest {
    ...
    static Stream<Arguments> cases() {
        return Stream.of(
                // Basic cases
                Arguments.of("hello world", "dhello worl"),
                Arguments.of("hello  world ", " hello  world"),
                Arguments.of("  hello  world  ", "   hello  world "),

                Arguments.of("\n ", " \n"),

                Arguments.of("🙂def", "f🙂de"),
    ...
    @ParameterizedTest
    @MethodSource("cases")
    void rotateRightTest(String input, String expected) {
        CodePointBuffer buffer = new CodePointBuffer(input.codePoints().toArray());

        CodePointUtils.rotateRight(buffer);
    ...
    void pipelineStepTest() {
        ...
        AbstractPipeline pipeline =
                new OperationsPipelineBuilder()
                        .pipe(ECodePointOperation.ROTATE_RIGHT)
                        .build();
